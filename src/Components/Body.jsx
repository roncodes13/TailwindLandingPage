    ...
    <div className="lg:flex">
      <div className="flex items-center justify-center lg:flex-1 lg:order-2 lg:justify-end lg:overflow-hidden">
        <img
          ...
          alt="img1"
          className="h-64 -rotate-45 md:h-72 lg:h-[450px] lg:overflow-hidden"
        />
        <img
          src="./assets/Pink-Shape.svg"
          alt="img2"
          className="absolute h-64 -rotate-[30deg]  md:h-72 lg:h-[450px] lg:overflow-hidden"
        />
        <img
          src="./assets/Purple-Shape.svg"
          alt="img3"
          className="absolute h-64 -rotate-[15deg]  md:h-72 lg:h-[450px] lg:overflow-hidden"
        />
        <img
